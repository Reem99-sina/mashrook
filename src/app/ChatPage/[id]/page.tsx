...
import {
  ...
  postMessage,
  postFileMessage,
} from "@/redux/features/getMessage";
    ...
    <>
      <div
        className={`flex flex-col  bg-white ${
          newMessages?.length == 0 ? "h-screen" : "min-h-screen"
        }`}
        style={{ direction: "rtl" }}
      >
        <div className="flex justify-between items-center p-4 gap-2 flex-row border-b">
          ...
          <div className="flex items-center justify-center gap-2 flex-row">
            ...
            <h1 className="text-sm font-bold text-[#36343B]">{title}</h1>
          </div>
                    ...
                    >
                      ...
                      {msg?.alert_message && (
                        <div className="bg-white rounded-lg shadow-lg flex flex-col items-center justify-center p-2">
                          <p className="text-[#98CC5D] text-sm">
                            {msg?.alert_message}
                          </p>
                          <p className="text-blue-450 text-xs">
                            {msg?.alert_message_text}
                          </p>
                        </div>
                      )}
                      {msg?.alert_link && (
        ...
        <div className="flex items-center border-t p-4 gap-2">
          <TextInput
            ...
            value={
              newMessage instanceof File == true && newMessage?.name
                ? newMessage?.name
                : newMessage
            }
          />
