  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><button
         className={` w-full rounded-lg text-start p-2 ${option=="oldest"?"bg-[#3B73B9] bg-opacity-25 text-blue-450":"bg-gray-100"} mb-2`} 
         onClick={() => onSort("oldest")}>الأقدم إلى الأحدث</button></li>
        <li><button
         className={`w-full rounded-lg text-start ${option=="priceLowToHigh"?"bg-[#3B73B9] bg-opacity-25 text-blue-450":"bg-gray-100"} p-2 mb-2`}
          onClick={() => onSort("priceLowToHigh")}>الميزانية (الأدنى إلى الأعلى)</button></li>
        <li><button 
        className={` w-full rounded-lg text-start p-2 mb-2 ${option=="priceHighToLow"?"bg-[#3B73B9] bg-opacity-25 text-blue-450":"bg-gray-100"}`}
