...
const CountElement: React.FC<CountElementInter> = ({
  value,
  onChange,
  title,
}) => {
  return (
    <div className="border-2 border-solid border-gray-200 rounded-md flex items-center justify-between">
      <button
        onClick={(e) => {
          e.preventDefault();
      ...
      >
        <Image src={Sub} width={21} height={21} alt={"add"} />
      </button>
    </div>
  );
};
