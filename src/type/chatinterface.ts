...
export const faqs= [
    {
      ...
      answer: "منصة عقارية مرخصة تتيح لعرض منتج قابل لشراكة بنظام التملك الحر او المشاع كذلك تتيح للمطور العقاري المعتمد أو المالك بخلق مشاركة في تطوير منتج عقاري بآلية محترفة وبمنظومة موثوقة كما تتيح سوق عقاري لعرض المنتجات بطريقة سهلة.",
    },
    {
      question: "ماهي القيمة السوقية اللي يضيفها مشروك للعميل؟",
      answer: "توفير حل للعميل في تملك العقار بطريقة التشارك وبقيمة تنافسية وخلق فرص تجارية للملاك والمطورين",
    },
    {
      question: "كيف أعرف بأن العقار المعروض في مشروك موثوق أو لا؟",
      answer: "لا يعرض المنتج العقاري بالسوق بالمنصة حتى يطابق معلوماته بالخرائط المكانية من ناحية المساحة والواجهات ومرتبط بأيقونة الهيئة العامة للعقار",
    },
    {
    ...
    {
      question: "هل بإمكاني استرداد الرسوم إذا بيع العقار أو تغيرت رغبتي أو اهتمامي بعد انضمامي كشريك أو تأخر الشريك الأخر أو لم تكتمل نسبة الشراكة؟",
      answer: "تسترد الرسوم في ثلاث حالات كالتالي: إذا تراجع البائع أو تعذر وجود شريك آخر أو أنسحب الشريك الآخر ",
    },
    {
        question: "	تمت الموافقة من الشركاء على شراء العقار ما هو الإجراء؟",
        answer: "التواصل مع الأطراف لتنسيق ومن ثم طلب تسليم السعي ومن ثم التنسيق مع الموثق لعملية الإفراغ ",
      },
      {
        question: "هل بالإمكان الدفع نقدًا سواء رسوم أو سعي عند الرغبة بالانضمام كشريك؟",
        answer: "لا يقبل الدفع نقدا والمنصة ومنسوبيها غير مسؤولين عن ذلك ",
      },
      {
        question: "كم تستغرق عملية الإفراغ؟",
        answer: "عند تواجد أطراف الصفقة (البائع والمشتري أو من ينوب عنهما بالوكالة) يتم الإفراغ الفوري",
      },
      {
        question: "هل المنصة تقدم خدمات أخرى ما بعد البيع؟",
        answer: "خدمات تجهيز محاضر الدمج والتجزئة والتصاميم الهندسية والإشراف والمقاول وخدمات أخرى باختيار العميل للجهات المتوفرة بالمنصة للقيام بالمهمة ويكون التعاقد معهم مباشرة ",
      },
      {
        question: "في حالة التطوير من هو الطرف الثالث لعملية ضبط التعاقد؟",
        answer: "محامي معتمد أو إذا كانت هناك منصات حكومية متوفرة لعمل ذلك برغبة الأطراف",
      },
      {
      ...
      {
        question: "كمطور عقاري أو مالك هل يحق لي اختيار محامي من طرفي أم المنصة هي من تختار؟",
...
`,
      },
      {
        ...
        question: "لو رغبت بمعلومات أكثر عن عقار وقبل الانضمام كشريك كيف التواصل مع المنصة؟",
        answer: `عبر قنوات التواصل أو زيارة مقر الشركة فريق التسويق `,
      },{
        question: "كوسيط عقاري أو مالك أو مطور عقاري في حالة الرغبة في حذف العرض أو الحساب هل ذلك متاح؟",
