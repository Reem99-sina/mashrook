...
export const postSave = createAsyncThunk<returnType, comeType>(
  "save/post",
...
export const getSaves = createAsyncThunk<returnType>(
  "save/get",
...
export const deleteSaves = createAsyncThunk<returnType, comeIdType>(
  "save/deleteSaves",
