...
export const fetchToken = createAsyncThunk('auth/fetchToken', async () => {  
  ...
  export const updateUserImage = createAsyncThunk('auth/updateUserImage', async (data:userImage) => {
    const formData = new FormData();
    formData.append("image",data?.image)
    const response = await axios.put("https://server.mashrook.sa/user/upload-image", formData,{
        headers: {
  ...
  export const updateUser = createAsyncThunk('auth/updateUser', async (data:userUpdata) => {
    const response = await axios.put("https://server.mashrook.sa/user", data,{
        headers: {
            Authorization: Cookie.get("token"),
          }
    }).then((response)=>response.data).catch((error)=>error?.response?.data)  // Adjust your endpoint as necessary 
  ...
  export const deleteUser = createAsyncThunk('auth/deleteuser', async () => {
    const response = await axios.delete("https://server.mashrook.sa/user",{
        headers: {
            Authorization: Cookie.get("token"),
          }
    }).then((response)=>response.data).catch((error)=>error?.response?.data)  // Adjust your endpoint as necessary 
