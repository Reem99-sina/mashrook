...
export const getRequest=createAsyncThunk<returnType>("requestGet", async (_, { rejectWithValue }) => {  
    const response = await axios.get("https://server.mashrook.sa/property/offer",{headers:{
