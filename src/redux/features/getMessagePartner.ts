...
export const getMessagePartners=createAsyncThunk<returnType>("partnersmessage/get", async (_, { rejectWithValue }) => {  
        const response = await axios.get(`https://server.mashrook.sa/room/partners`,{
            headers: {
